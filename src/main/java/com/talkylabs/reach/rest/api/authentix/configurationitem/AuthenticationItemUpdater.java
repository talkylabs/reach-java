...
public class AuthenticationItemUpdater extends Updater<AuthenticationItem>{
    private String pathConfigurationId;
    private String pathAuthenticationId;
    private AuthenticationItem.Status status;

    public AuthenticationItemUpdater(final String pathConfigurationId, final String pathAuthenticationId, final AuthenticationItem.Status status){
        this.pathConfigurationId = pathConfigurationId;
        this.pathAuthenticationId = pathAuthenticationId;
        this.status = status;
    }

    public AuthenticationItemUpdater setStatus(final AuthenticationItem.Status status){
        this.status = status;
        return this;
    }

    @Override
    public AuthenticationItem update(final ReachRestClient client){
        ...
        if (response == null) {
            throw new ApiConnectionException("AuthenticationItem update failed: Unable to connect to server");
