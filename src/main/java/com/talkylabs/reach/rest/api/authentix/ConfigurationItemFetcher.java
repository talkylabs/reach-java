...
public class ConfigurationItemFetcher extends Fetcher<ConfigurationItem> {
    private String pathConfigurationId;

    public ConfigurationItemFetcher(final String pathConfigurationId){
        this.pathConfigurationId = pathConfigurationId;
    }


    @Override
    public ConfigurationItem fetch(final ReachRestClient client) {
        ...
        if (response == null) {
        throw new ApiConnectionException("ConfigurationItem fetch failed: Unable to connect to server");
