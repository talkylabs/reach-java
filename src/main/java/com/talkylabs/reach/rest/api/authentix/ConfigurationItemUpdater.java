...
public class ConfigurationItemUpdater extends Updater<ConfigurationItem>{
    ...
    public ConfigurationItemUpdater(final String pathConfigurationId){
        this.pathConfigurationId = pathConfigurationId;
    }

    public ConfigurationItemUpdater setServiceName(final String serviceName){
        this.serviceName = serviceName;
        return this;
    }
    public ConfigurationItemUpdater setCodeLength(final Integer codeLength){
        this.codeLength = codeLength;
        return this;
    }
    public ConfigurationItemUpdater setAllowCustomCode(final Boolean allowCustomCode){
        this.allowCustomCode = allowCustomCode;
        return this;
    }
    public ConfigurationItemUpdater setUsedForDigitalPayment(final Boolean usedForDigitalPayment){
        this.usedForDigitalPayment = usedForDigitalPayment;
        return this;
    }
    public ConfigurationItemUpdater setDefaultExpiryTime(final Integer defaultExpiryTime){
        this.defaultExpiryTime = defaultExpiryTime;
        return this;
    }
    public ConfigurationItemUpdater setDefaultMaxTrials(final Integer defaultMaxTrials){
        this.defaultMaxTrials = defaultMaxTrials;
        return this;
    }
    public ConfigurationItemUpdater setDefaultMaxControls(final Integer defaultMaxControls){
        this.defaultMaxControls = defaultMaxControls;
        return this;
    }
    public ConfigurationItemUpdater setSmtpSettingId(final String smtpSettingId){
        this.smtpSettingId = smtpSettingId;
        return this;
    }
    public ConfigurationItemUpdater setEmailTemplateId(final String emailTemplateId){
        this.emailTemplateId = emailTemplateId;
        return this;
    }
    public ConfigurationItemUpdater setSmsTemplateId(final String smsTemplateId){
        this.smsTemplateId = smsTemplateId;
        return this;
    }

    @Override
    public ConfigurationItem update(final ReachRestClient client){
        ...
        if (response == null) {
            throw new ApiConnectionException("ConfigurationItem update failed: Unable to connect to server");
