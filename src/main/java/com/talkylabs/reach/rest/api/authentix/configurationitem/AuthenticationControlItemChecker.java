...
import com.talkylabs.reach.base.Checker;
...
public class AuthenticationControlItemChecker extends Checker<AuthenticationControlItem>{
    ...
    public AuthenticationControlItemChecker(final String pathConfigurationId) {
        this.pathConfigurationId = pathConfigurationId;
    }

    public AuthenticationControlItemChecker setDest(final String dest){
        this.dest = dest;
        return this;
    }
    public AuthenticationControlItemChecker setCode(final String code){
        this.code = code;
        return this;
    }
    public AuthenticationControlItemChecker setAuthenticationId(final String authenticationId){
        this.authenticationId = authenticationId;
        return this;
    }
    public AuthenticationControlItemChecker setPaymentInfo(final String paymentInfo){
        this.paymentInfo = paymentInfo;
        return this;
    }

    @Override
    public AuthenticationControlItem check(final ReachRestClient client){
        ...
        if (response == null) {
            throw new ApiConnectionException("AuthenticationControlItem send operation failed: Unable to connect to server");
        ...
        return AuthenticationControlItem.fromJson(response.getStream(), client.getObjectMapper());
    }
    private void addPostParams(final Request request) {
        ...
        if (authenticationId != null) {
            request.addPostParam("authenticationId", authenticationId);
