...
public class ConfigurationItemReader extends Reader<ConfigurationItem> {
    private Integer pageSize;

    public ConfigurationItemReader(){
    }

    public ConfigurationItemReader setPageSize(final Integer pageSize){
        this.pageSize = pageSize;
        return this;
    }

    @Override
    public ResourceSet<ConfigurationItem> read(final ReachRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<ConfigurationItem> firstPage(final ReachRestClient client) {
    ...
    private Page<ConfigurationItem> pageForRequest(final ReachRestClient client, final Request request) {
        Response response = client.request(request);

        if (response == null) {
            throw new ApiConnectionException("ConfigurationItem read failed: Unable to connect to server");
    ...
    @Override
    public Page<ConfigurationItem> previousPage(final Page<ConfigurationItem> page, final ReachRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<ConfigurationItem> nextPage(final Page<ConfigurationItem> page, final ReachRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<ConfigurationItem> getPage(final String targetUrl, final ReachRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
            targetUrl
        );
