...
public class AuthenticationItemReader extends Reader<AuthenticationItem> {
    private String pathConfigurationId;
    private Integer pageSize;

    public AuthenticationItemReader(final String pathConfigurationId){
        this.pathConfigurationId = pathConfigurationId;
    }

    public AuthenticationItemReader setPageSize(final Integer pageSize){
        this.pageSize = pageSize;
        return this;
    }

    @Override
    public ResourceSet<AuthenticationItem> read(final ReachRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<AuthenticationItem> firstPage(final ReachRestClient client) {
    ...
    private Page<AuthenticationItem> pageForRequest(final ReachRestClient client, final Request request) {
        Response response = client.request(request);

        if (response == null) {
            throw new ApiConnectionException("AuthenticationItem read failed: Unable to connect to server");
        ...
        return Page.fromJson(
            ...
            "authentications",
            response.getContent(),
            AuthenticationItem.class,
            client.getObjectMapper()
        );
    }

    @Override
    public Page<AuthenticationItem> previousPage(final Page<AuthenticationItem> page, final ReachRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<AuthenticationItem> nextPage(final Page<AuthenticationItem> page, final ReachRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<AuthenticationItem> getPage(final String targetUrl, final ReachRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
            targetUrl
        );
