...
public class MessagingItemFetcher extends Fetcher<MessagingItem> {
    private String messageId;

    public MessagingItemFetcher(final String messageId){
        this.messageId = messageId;
    }

    public MessagingItemFetcher setMessageId(final String messageId){
        this.messageId = messageId;
        return this;
    }

    @Override
    public MessagingItem fetch(final ReachRestClient client) {
        ...
        if (response == null) {
        throw new ApiConnectionException("MessagingItem fetch failed: Unable to connect to server");
    ...
    private void addQueryParams(final Request request) {
        if (messageId != null) {
            ...
            request.addQueryParam("messageId", messageId);
        }
    }
}
