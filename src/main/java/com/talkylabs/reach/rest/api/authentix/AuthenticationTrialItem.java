...
@ToString
public class AuthenticationTrialItem extends Resource {
    private static final long serialVersionUID = 176828654277825L;

    public static AuthenticationTrialItemFetcher fetcher(final String pathTrialId){
        return new AuthenticationTrialItemFetcher(pathTrialId);
    }

    public static AuthenticationTrialItemReader reader(){
        return new AuthenticationTrialItemReader();
    }

    /**
    * Converts a JSON String into a AuthenticationTrialItem object using the provided ObjectMapper.
    *
    * @param json Raw JSON String
    * @param objectMapper Jackson ObjectMapper
    * @return AuthenticationTrialItem object represented by the provided JSON
    */
    public static AuthenticationTrialItem fromJson(final String json, final ObjectMapper objectMapper) {
        // Convert all checked exceptions to Runtime
        try {
            return objectMapper.readValue(json, AuthenticationTrialItem.class);
    ...
    /**
    * Converts a JSON InputStream into a AuthenticationTrialItem object using the provided
    * ObjectMapper.
    *
    ...
    * @return AuthenticationTrialItem object represented by the provided JSON
    */
    public static AuthenticationTrialItem fromJson(final InputStream json, final ObjectMapper objectMapper) {
        // Convert all checked exceptions to Runtime
        try {
            return objectMapper.readValue(json, AuthenticationTrialItem.class);
        } catch (final JsonMappingException | JsonParseException e) {
    ...
    private final AuthenticationTrialItem.TrialStatus trialStatus;
    private final AuthenticationTrialItem.Channel channel;
    private final PaymentInfo paymentInfo;
    private final ZonedDateTime dateCreated;
    private final ZonedDateTime dateUpdated;
    private final BigDecimal price;
    private final String priceUnit;
    private final Map<String, Object> channelInfo;

    @JsonCreator
    private AuthenticationTrialItem(
        ...
        final AuthenticationTrialItem.TrialStatus trialStatus,

        @JsonProperty("channel")
        final AuthenticationTrialItem.Channel channel,
        ...
        final Map<String, Object> channelInfo
    ) {
        ...
        public final AuthenticationTrialItem.TrialStatus getTrialStatus() {
            return this.trialStatus;
        }
        public final AuthenticationTrialItem.Channel getChannel() {
            return this.channel;
        }
    ...
    public boolean equals(final Object o) {
        ...
        AuthenticationTrialItem other = (AuthenticationTrialItem) o;

        return Objects.equals(appletId, other.appletId) &&  Objects.equals(apiVersion, other.apiVersion) &&  Objects.equals(configurationId, other.configurationId) &&  Objects.equals(authenticationId, other.authenticationId) &&  Objects.equals(trialId, other.trialId) &&  Objects.equals(trialStatus, other.trialStatus) &&  Objects.equals(channel, other.channel) &&  Objects.equals(paymentInfo, other.paymentInfo) &&  Objects.equals(dateCreated, other.dateCreated) &&  Objects.equals(dateUpdated, other.dateUpdated) &&  Objects.equals(price, other.price) &&  Objects.equals(priceUnit, other.priceUnit) &&  Objects.equals(channelInfo, other.channelInfo)  ;
    }

    @Override
    public int hashCode() {
        return Objects.hash(appletId, apiVersion, configurationId, authenticationId, trialId, trialStatus, channel, paymentInfo, dateCreated, dateUpdated, price, priceUnit, channelInfo);
    }
