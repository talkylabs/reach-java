...
public class ResourceSet<E extends Resource> implements Iterable<E> {
    ...
    private final ReachRestClient client;
     ...
     */
    public ResourceSet(final Reader<E> reader, final ReachRestClient client, final Page<E> page) {
        this.reader = reader;
        this.client = client;
        this.page = page;
    ...
    public ResourceSet<E> setLimit(final int limit) {
        reader.limit(limit);
        return this;
    }
