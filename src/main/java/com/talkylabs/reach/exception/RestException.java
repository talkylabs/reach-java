...
public class RestException {
    ...
    /**
     * Initialize a Reach Rest Exception.
     *
     * @param status HTTP status code
     * @param message message of exception
     * @param code Reach status code
     * @param moreInfo further information, if there is any
     */
    @JsonCreator
    private RestException(@JsonProperty("status") final int status, @JsonProperty("errorMessage") final String message,
                          @JsonProperty("errorCode") final Integer code, @JsonProperty("more_info") final String moreInfo,
                          @JsonProperty("errorDetails") final Map<String, Object> details) {
        this.status = status;
