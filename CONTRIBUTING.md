# Contributing to `reach-java`

We'd love for you to contribute to our source code and to make `reach-java`
...
Help us keep `reach-java` open and inclusive. Please be kind to and considerate
of other developers, as we all have the same goal: make `reach-java` as good as
it can be.

## <a name="question"></a> Got an API/Product Question or Problem?

If you have questions about how to use `reach-java`, please see our
...
* **Major Changes** that you wish to contribute to the project should be
  discussed first with `reach-java` contributors in an issue or pull request so
...
* **`reach-java` Version(s)** - is it a regression?
...
* Run the full `reach-java` test suite (aliased by `make test`), and ensure
  that all tests pass.
...
In GitHub, send a pull request to `reach-java:main`.
If we suggest changes, then:

* Make the required updates.
* Re-run the `reach-java` test suite to ensure tests are still passing.
...
[issue-link]: https://github.com/talkylabs/reach-java/issues/new
[github]: https://github.com/talkylabs/reach-java